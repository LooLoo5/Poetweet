<template>
  <div class="container" id="postForm">
    ...
    <div class="form-row mt-5">
      ...
      <input type="text" name="title" class="form-control" placeholder="stay creative" v-model="post.title">
    </div>
    <div class="form-row mt-2">
      <label for="title"><b>Type in a Story</b></label>
      <textarea name="body" v-model="post.body" class="form-control" placeholder="any story under 140 characters" maxlength="140"/>
    </div>
    <button
